...
namespace RAMMS.DTO
{
    public class RmAllassetInventoryDTO
    {
        ...
        public int? AiDiameter { get; set; }
        public int? AiWidth { get; set; }
        public int? AiHeight { get; set; }
        public string AiMaterial { get; set; }
        public int? AiFinRdLevel { get; set; }
        public int? AiCatchArea { get; set; }
        public int? AiSkew { get; set; }
        public int? AiDesignFlow { get; set; }
        public int? AiLength { get; set; }
        public string AiPrecastSitu { get; set; }
        public int? AiBarrelNo { get; set; }
        public int? AiIntelLevel { get; set; }
        public string AiIntelStruc { get; set; }
        public int? AiOutletLevel { get; set; }
        public string AiOutletStruc { get; set; }
        public string AiOwner { get; set; }
        public string AiMaintainedBy { get; set; }
        public decimal? AiGpsEasting { get; set; }
        public decimal? AiGpsNorthing { get; set; }
        public string AiRiverName { get; set; }
        public int? AiWidthLane { get; set; }
        public int? AiLengthSpan { get; set; }
        public string AiBridgeName { get; set; }
        public int? AiLaneCnt { get; set; }
        public int? AiSpanCnt { get; set; }
        public int? AiMedian { get; set; }
        public int? AiWalkway { get; set; }
        ...
        public int? AiExpanJointSpace { get; set; }
        ...
        public int? AiPostSpacing { get; set; }
        public int? AiTier { get; set; }
        public int? AiBotWidth { get; set; }
