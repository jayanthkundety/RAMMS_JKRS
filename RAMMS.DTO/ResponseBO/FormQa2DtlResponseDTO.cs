...
{
    public class FormQa2DtlResponseDTO
    {
        public FormQa2DtlResponseDTO()
        {
        ...
        [MapTo("FqaiidFsidPkRefNoNavigation")]
        public virtual FormQa2HeaderResponseDTO S1Detail { get; set; }
