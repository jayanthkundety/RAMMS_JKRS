...
{
    public class FormJHeaderResponseDTO
    {

        public FormJHeaderResponseDTO()
        {
            FormADetails = new List<FormJDetailResponseDTO>();
        }
        ...
        public List<FormJDetailResponseDTO> FormADetails { get; set; }
