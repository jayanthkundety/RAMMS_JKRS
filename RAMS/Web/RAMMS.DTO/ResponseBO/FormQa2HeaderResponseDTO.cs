...
{
    public class FormQa2HeaderResponseDTO
    {
        public FormQa2HeaderResponseDTO()
        {
            FormQa2Details = new List<FormQa2DtlResponseDTO>();
        }
        ...
        [MapTo("FormN1Header")]
        public virtual ICollection<FormN1HeaderResponseDTO> FormN1Header { get; set; }
        [MapTo("FormQa2Detaill")]
        public virtual ICollection<FormQa2DtlHeaderResponseDTO> FormQa2Detail { get; set; }

        public List<FormQa2DtlResponseDTO> FormQa2Details { get; set; }
