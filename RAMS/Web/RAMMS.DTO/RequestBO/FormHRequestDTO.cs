...
namespace RAMMS.DTO.RequestBO
{
    public class FormHRequestDTO
    {
        ...
        [MapTo("FhhStsDtSubAuth")]
        public DateTime? SentJKRSDate { get; set; }

        [MapTo("FhhStsDtRcvdAuth")]
        public DateTime? RecievedFromJKRSDate { get; set; }
