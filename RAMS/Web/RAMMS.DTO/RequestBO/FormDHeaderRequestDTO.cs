...
{
    public class FormDHeaderRequestDTO
    {
        public FormDHeaderRequestDTO()
        {
        ...
        public List<FormDDetailsRequestDTO> FormDDetails { get; set; }

        public List<FormDMaterialDetailsRequestDTO> FormDMaterial { get; set; }

        public List<FormDEquipRequestDTO> FormDEquip { get; set; }

        public List<FormDLabourDetailsRequestDTO> FormDLabour { get; set; }
