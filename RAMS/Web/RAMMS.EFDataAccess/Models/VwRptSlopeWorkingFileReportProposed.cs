...
{
    public partial class VwRptSlopeWorkingFileReportProposed
    {
        ...
        public DateTime? PrevInspDate { get; set; }
        public string PrevCond { get; set; }
        public string Fi { get; set; }
        public string RemedialWorks { get; set; }
        public string ObservationOnfRmWorks { get; set; }
