...
{
    public partial class PitTask
    {
        public PitTask()
        {
            PitTaskDamage = new HashSet<PitTaskDamage>();
            PitTaskOnDuty = new HashSet<PitTaskOnDuty>();
            PitTaskPhoto = new HashSet<PitTaskPhoto>();
            PitTaskUserSign = new HashSet<PitTaskUserSign>();
            PitTaskVehicle = new HashSet<PitTaskVehicle>();
        }
        ...
        public virtual PitTaskStructure PitTaskStructurePkNavigation { get; set; }
        public virtual ICollection<PitTaskDamage> PitTaskDamage { get; set; }
        public virtual ICollection<PitTaskOnDuty> PitTaskOnDuty { get; set; }
        public virtual ICollection<PitTaskPhoto> PitTaskPhoto { get; set; }
        public virtual ICollection<PitTaskUserSign> PitTaskUserSign { get; set; }
        public virtual ICollection<PitTaskVehicle> PitTaskVehicle { get; set; }
    }
}
