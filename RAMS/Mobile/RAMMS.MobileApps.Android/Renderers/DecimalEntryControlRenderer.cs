...
[assembly: ExportRenderer(typeof(DecimalEntryControl), typeof(DecimalEntryControlRenderer))]

namespace RAMMS.MobileApps.Droid
{
    public class DecimalEntryControlRenderer : EntryRenderer
    {
        public DecimalEntryControlRenderer(Context context) : base(context)
        {
        }
        ...
        public DecimalEntryControlRenderer()
        {
