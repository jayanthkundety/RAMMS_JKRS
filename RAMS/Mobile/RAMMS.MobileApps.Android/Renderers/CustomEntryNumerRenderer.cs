...
[assembly: ExportRenderer(typeof(CustomEntryNumber), typeof(CustomEntryNumerRenderer))]

namespace RAMMS.MobileApps.Droid.Renderers
{
    class CustomEntryNumerRenderer : EntryRenderer
    {
        public CustomEntryNumerRenderer(Context context) : base(context)
        {
        }
        ...
        public CustomEntryNumerRenderer()
        {
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<Entry> e)
        {
            ...
            if (Control != null)
            {
                ...
                if (e.NewElement.Keyboard == Keyboard.Numeric || e.NewElement.Keyboard == Keyboard.Telephone)
                {
                    ...
                    {
                        Control.SetRawInputType(Android.Text.InputTypes.ClassNumber | Android.Text.InputTypes.ClassNumber);
                    }
                    else
                    {
                        Control.SetRawInputType(Android.Text.InputTypes.ClassNumber | Android.Text.InputTypes.NumberFlagDecimal);
                    }
                }
                if (e.NewElement.IsPassword)
                {
