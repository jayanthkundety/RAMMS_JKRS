...
//{
//    class TextChangedEventToCommandEntryControlRenderer
//    {
//    }
//}
...
[assembly: ExportRenderer(typeof(TextChangedEventToCommandEntryControl), typeof(TextChangedEventToCommandEntryControlRenderer))]

namespace RAMMS.MobileApps.Droid
{
    public class TextChangedEventToCommandEntryControlRenderer : EntryRenderer
    {
        public TextChangedEventToCommandEntryControlRenderer(Context context) : base(context)
        {
        }
        ...
        public TextChangedEventToCommandEntryControlRenderer()
        {
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<Entry> e)
        {
            ...
            if (Control != null)
            {
                ...
                if (e.NewElement.Keyboard == Keyboard.Numeric || e.NewElement.Keyboard == Keyboard.Telephone)
                {
                    ...
                    {
                        Control.SetRawInputType(Android.Text.InputTypes.ClassNumber | Android.Text.InputTypes.DatetimeVariationDate);
                    }
                    else
                    {
                        Control.SetRawInputType(Android.Text.InputTypes.ClassNumber | Android.Text.InputTypes.DatetimeVariationDate);
