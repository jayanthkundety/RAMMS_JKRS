...
namespace RAMMS.MobileApps.Page
{
    ...
    public partial class CameraPopUpPage : PopupPage
    {
        ...
        public async Task<ObservableCollection<DDListItems>> GetddListDetails(string ddtype)
        {
            ...
            {
                await DisplayAlert(ex.Message, "RAMMS", "OK");
        ...
        private async void SelectImagesButton_Clicked(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    await DisplayAlert("RAMMS", "Please select Photo Type", "OK");
                    return;
                }
        ...
        private async void Button_Clicked_1(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (App.HeaderCode == 0)
                {
                    await DisplayAlert("RAMMS", "Asset value is not found. Please add data and try again.", "OK");
                    return;
                }
                ...
                if (CrossConnectivity.Current.IsConnected)
                {
                    ...
                    try
                    {
                        ...
                        {
                            await DisplayAlert("RAMMS", "Please select an image.", "OK");
                            return;
                        }
                        ...
                        using (var formData = new MultipartFormDataContent())
                        {
                            ...
                            try
                            {
                                ...
                                var res1 = await client.PostAsync(AppConst.ImageApiBaseAddress, formData);
                                ...
                                {
                                    await DisplayAlert("RAMMS","Internet Connection Failed. Please check try again." , "OK");
        ...
        private async void Button_Clicked_3(object sender, EventArgs e)
        {
            try
            {
                ...
                var file = await CrossMedia.Current.TakePhotoAsync(new StoreCameraMediaOptions { SaveToAlbum = true, Name = "Test", Directory = "FormA", CompressionQuality = 40 });
                ...
                if (file != null)
                {
                    ...
                    if (filesize > 5)
                    {
                        ...
                        await DisplayAlert("RAMMS","Maximum 5Mb files allowed","OK");
                        return;
                    }
