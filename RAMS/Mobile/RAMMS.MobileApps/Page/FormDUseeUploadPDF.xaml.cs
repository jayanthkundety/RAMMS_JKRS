...
namespace RAMMS.MobileApps.Page
{
    ...
    public partial class FormDUseeUploadPDF : ContentPage
    {
        ...
        private async void SelectImagesButton_Clicked(object sender, EventArgs e)
        {
            try
            {
                if (phototypepicker.SelectedIndex == -1)
                {
                    await UserDialogs.Instance.AlertAsync("Please select U See U/ Accident Type ", "RAMS", "OK");
                    return;
                }
