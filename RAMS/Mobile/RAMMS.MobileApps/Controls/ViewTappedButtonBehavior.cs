        ...
        void View_Tapped(object sender, EventArgs e)
        {
            ...
            Device.BeginInvokeOnMainThread(async () =>
            {
                try
                {
                    ...
                    {
                        await view.FadeTo(5, 400);
                        await view.FadeTo(7, 400);
                    }
                    else if (AnimationType == AnimationType.Scale)
                    {
                        await view.ScaleTo(1.2, 100, easing: Easing.Linear);
                        await view.ScaleTo(0.9, 100, easing: Easing.Linear);
                    }
                    ...
                    else if (AnimationType == AnimationType.FlipHorizontal)
                    {
                        ...
                        await view.RotateYTo(90, 500);
                        await view.RotateYTo(0, 500);
                    }
