        ...
        private void AddStyles()
        {
            var unselectedStyle = new Style(typeof(Button))
            {
                Setters = {
                    ...
                    new Setter { Property = Button.BorderWidthProperty,   Value = 0.9 },
                    new Setter { Property = Button.BorderRadiusProperty,   Value = 20 },
                    new Setter { Property = HeightRequestProperty,   Value = 50 },
                    new Setter { Property = WidthRequestProperty,   Value = 50 }
            }
            };
