...
{
    //class FormC1C2CameraPopupPageModel : FreshBasePageModel
    //{
    ...
    //                    var file = CrossMedia.Current.TakePhotoAsync(new StoreCameraMediaOptions { SaveToAlbum = true, Name = "Test", Directory = "FormA", CompressionQuality = 40 });
    ...
    //                        //    // DisplayAlert("RAMMS", "Maximum 5Mb files allowed", "OK");
    //                        //    return;
    //                        //}
    ...
    public class FormC1C2CameraPopupPageModel : FreshBasePageModel
    {
        ...
        public FormC1C2CameraPopupPageModel(IRestApi restApi, IUserDialogs userDialogs, ILocalDatabase localDatabase)
        {
            ...
            get
            {
                return new Command(async (obje) =>
                {
                    try
                    {
                        ...
                        var file = await CrossMedia.Current.TakePhotoAsync(new StoreCameraMediaOptions { SaveToAlbum = true, Name = "Test", Directory = "FormC1C2", CompressionQuality = 40 });
        ...
        public void listfiles(ObservableCollection<string> ImageList)
        {
            try
            {
                var path1 = "/storage/emulated/0/Pictures/FormC1C2/";
                        ...
                        if (CrossConnectivity.Current.IsConnected)
                        {
                            try
                            {
                                ...
                                using (var formData = new MultipartFormDataContent())
                                {
                                    ...
                                    formData.Add(new StringContent(App.HeaderCode.ToString()), "headerId");
                                    formData.Add(new StringContent(App.InspReferenceNo.ToString()), "InspRefNum");
                                    ...
                                    try
                                    {
                                        ...
                                        var res1 = await client.PostAsync(AppConst.ImageApiBaseFormC1C2Address, formData);
