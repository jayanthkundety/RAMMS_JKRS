...
{
    public partial class PiResultBridge
    {
        public PiResultBridge()
        {
            PiResultBridgeFurtherInvestigation = new HashSet<PiResultBridgeFurtherInvestigation>();
            PiResultBridgePhoto = new HashSet<PiResultBridgePhoto>();
            PiResultBridgeRemedialWork = new HashSet<PiResultBridgeRemedialWork>();
            PiResultBridgeRoutineWork = new HashSet<PiResultBridgeRoutineWork>();
        }
        ...
        public virtual ICollection<PiResultBridgeFurtherInvestigation> PiResultBridgeFurtherInvestigation { get; set; }
        public virtual ICollection<PiResultBridgePhoto> PiResultBridgePhoto { get; set; }
        public virtual ICollection<PiResultBridgeRemedialWork> PiResultBridgeRemedialWork { get; set; }
        public virtual ICollection<PiResultBridgeRoutineWork> PiResultBridgeRoutineWork { get; set; }
    }
}
