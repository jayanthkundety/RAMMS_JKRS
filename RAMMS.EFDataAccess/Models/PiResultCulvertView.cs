...
{
    public partial class PiResultCulvertView
    {
        public string SectionCode { get; set; }
        public string FeatureBound { get; set; }
        public string FeatureRoute { get; set; }
        public double? CulvertKmlocation { get; set; }
        public double? CulvertLatitude { get; set; }
        public double? CulvertLongitude { get; set; }
